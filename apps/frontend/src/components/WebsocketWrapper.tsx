...
export function WebsocketWrapper({children,token} : {children : React.ReactNode,token : string}){
    console.log("websocket wrapper called")
    // enter ws url here
    const ws = new ReconnectingWebSocket(import.meta.env.VITE_WEBSOCKET_URL,token)
